...
TD <- est.R0.TD(Rovigo.2020, mGT, begin=1, end=195, nsim=1450)
...
png(file = "C:\\Users\\alice\\Desktop\\Tesi\\File\\R PROJECT\\R PROJECT\\R0-master\\data\\plots\\Rovigo.png", width = 1000, height = 400)
plot(TD.weekly)
dev.off()
